...
def test_for_1_dollar 
assert_equal({penny:0, nickle:0, dime:0, quarter:0, dollar:1},coin_change_counter(100))
end

def test_for_4_dollar
assert_equal({penny:0, nickle:0, dime:0, quarter:0, dollar:1}, coin_change_counter(100+100+100))
end
